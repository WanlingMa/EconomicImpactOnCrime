...
The source code and data for this report are available on GitHub at [link](https://github.com/WanlingMa/EconomicImpactOnCrime.git).
...
### 3.2.1 Data Analysis Methodology

#### 3.2.1.1 Correlation Matrix
...
### 3.2.2 Analysis 1: Crime Rate vs. Education Attainment
...
We then used cor() function to create a correlation matrix to quickly determine whether or not some specific crimes rate have correlation to the education levels that each individual in the neighbourhood acquired [@R-base]. And then we use ggplot2 library to generate a heatmap to provide an elegant and efficient data visualization [@R-ggplot2].
...
\newpage
### 3.2.3 Analysis 2: Crime Rate vs. Major Field of Study

We first compare various crime rates versus some popular field of study:
...
A correlation matrix is calculated to quickly determine whether or not some specific crimes rate have correlation to the major of study that each individual in the neighbourhood focus using cor() function [@R-base]:
...
\newpage
### 3.2.4 Analysis 3: Crime Rate vs. Household After-Tax Income

We first compare various crime rates versus various income levels:
...
#### 3.2.4.1 Data Visualization

We then used a correlation matrix to quickly determine whether or not some specific crimes rate have correlation to various income levels:
